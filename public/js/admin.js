...
function updateRate() {
  foreignAmount.value = parseFloat(document.getElementById("baseAmount").value) * parseFloat(exRate.value);
} // CHECK SELECT
...
baseAmount.addEventListener("change", updateRate); // GENERATORE INFORMAZIONI PAGINA TRADE
...
if (btnGenerator) {
  btnGenerator.addEventListener("click", function () {
    ...
    var coinForeign = option2.getAttribute("data-name").toLowerCase(); // GENERAZIONE SLUG

    var eleSlugTrade = document.querySelector("#slugRes");
    var tradeDir = document.querySelector("#tradeDir").value;
    var name = coinBase + tradeDir + coinForeign; // INSERIMENTO PREZZI IN BASE ALLA DATA
    ...
    Axios.all([reqOne, reqTwo, reqThree]).then(Axios.spread(function () {
      for (var _len = arguments.length, responses = new Array(_len), _key = 0; _key < _len; _key++) {
        responses[_key] = arguments[_key];
      }

      // PREZZO DI CAMBIO TRA DUE ASSET
      exRate.value = responses[0].data.market_data.current_price.usd / responses[1].data.market_data.current_price.usd; // BASE ASSET VALUE

      baseUsd.value = responses[0].data.market_data.current_price.usd; // FOREIGN ASSET VALUE

      foreignUsd.value = responses[1].data.market_data.current_price.usd; // GENERATORE SLUG
...
__webpack_require__(/*! /Users/ture/Desktop/Bool/laravel-api/resources/js/admin.js */"./resources/js/admin.js");
module.exports = __webpack_require__(/*! /Users/ture/Desktop/Bool/laravel-api/resources/sass/app.scss */"./resources/sass/app.scss");
